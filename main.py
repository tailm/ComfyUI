...
def start_comfyui(asyncio_loop=None):
    ...
    # Start a local proxy on 0.0.0.0:11434 that forwards to localhost:11434
    try:
        asyncio_loop.run_until_complete(prompt_server.start_localhost_port_proxy(host="192.168.50.228"))
    except Exception as e:
        logging.warning(f"Failed to start localhost proxy on port 11434: {e}")
