const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./onboardingCloudRoutes-DCcIXn4P.js","./rolldown-runtime-w0pxe0c8.js","./vendor-primevue-rx7tKw03.js","./vendor-vue-core-D3WB7mNE.js","./oauthState-0r1ukMzs.js","./GraphView-Cb-m_EyV.js","./_plugin-vue_export-helper-BTZD_w11.js","./promotionUtils-vKoNYnM9.js","./vendor-other-CcVI76zn.js","./vendor-firebase-C7k8AidI.js","./vendor-three-BgtZEsKh.js","./vendor-tiptap-Da8lvoX9.js","./vendor-zod-9ZYBvZOX.js","./vendor-reka-ui-3rzHRTLU.js","./vendor-i18n-BVGbvPvq.js","./vendor-sentry-CJqm_Nmo.js","./vendor-vueuse-BA2QXdyV.js","./vendor-axios-CCRjO_8I.js","./vendor-markdown-ZOM1KON6.js","./vendor-yjs-DF9PYGyQ.js","./api-DrovjuJk.js","./types-4cVPtFn2.js","./toastStore-BIphcVgz.js","./devFeatureFlagOverride-BkGrEGSd.js","./formatUtil-B15pKy0Z.js","./src-CDgHMYTj.js","./downloadUtil-DVwV9jPP.js","./i18n-DAE2CSwM.js","./commands-DD5bW_sz.js","./main-mdv62577.js","./nodeDefs-BSMa-osx.js","./settings-C20_o31_.js","./WaveAudioPlayer-B565XRpq.js","./Button-BDFBPNkK.js","./Slider-C_rx-g3O.js","./DialogHeader-DkWnDCOh.js","./dialogStore-DD1yBh6P.js","./Loader-BDNSi0qc.js","./Popover-CZfXPPLp.js","./useModalLiftedZIndex-CHOpgGKh.js","./ColorPicker-CzfjYyaP.js","./SelectValue-DqyfA2Es.js","./Input-DH6Bhvfp.js","./extensionStore-rc50enKT.js","./useErrorHandling-DNyo9FnY.js","./useExternalLink-lnTgXLgb.js","./envUtil-BjE8ep-x.js","./useFeatureFlags-DVgtsxbC.js","./remoteConfig-DjUkM6Dg.js","./useImageQuiet-Cr1HOQ5t.js","./VideoPlayOverlay-BHVjultu.js","./useFeatureUsageTracker-Dmo_jNxY.js","./telemetry-BQKS_Is7.js","./topupTracker-DNKc8Xp6.js","./userStore-BKADmpNR.js","./widgetTypes-oIdIlxxV.js","./markdownRendererUtil-B-BSW0UD.js","./useConflictDetection-Cu2ufjrq.js","./errorUtil-CVYb13Xf.js","./ScrubableNumberInput-l6kdE50m.js","./UserAvatar-CTTivE3x.js","./curveUtils-DPQ6mla8.js","./GlobalToast-D8zwEjjb.js","./TopbarBadge-K3OBXOuv.js","./graphHasMissingNodes-BlFtKDC_.js","./useClickDragGuard-B3h3Ov-P.js","./SubscribeButton-Cz0Hx2AO.js","./SubscribeToRun-CCxqqNrR.js","./keybindingService-dfsNdrQo.js","./missingModelDownload-DO8CWvXT.js","./config-B2VX_hK9.js","./releaseStore-CHhBv4ZC.js","./workflowShareService-C0IhjUMY.js","./WorkspaceProfilePic-DA3oYgmE.js","./useWorkspaceTierLabel-C_lQjvzH.js","./useTransformState-B97cH_dL.js","./layout-BqEAXJgV.js","./serverConfigStore-CN4Xkrt5.js","./hdrFormatUtil-D-Y86x4W.js","./vendor-other-DODGPXtn.css","./promotionUtils-DnZm_YOl.css","./useConflictDetection-BulFL8Bd.css","./GraphView-AszlX357.css","./LoginView-kUQEskZH.js","./auth-sAZvtlsO.js","./auth-DbePuc5y.js","./refreshRemoteConfig-kXEJbu09.js","./refreshRemoteConfig-B062BsUD.js","./initHostTelemetry-B5KQBQja.js"])))=>i.map(i=>d[i]);
import "./rolldown-runtime-w0pxe0c8.js";
import { A as script$1, T as script, at as PrimeVue, ct as index, lt as definePreset, nt as Tooltip, rt as ToastService, tt as __vitePreload } from "./vendor-primevue-rx7tKw03.js";
...
import { B as createVNode, E as Fragment, F as createElementBlock, H as defineComponent, Kt as toDisplayString, L as createSlots, M as createBaseVNode, Mt as ref, N as createBlock, P as createCommentVNode, St as withDirectives, Ut as normalizeClass, Vt as unref, X as mergeProps, _t as watch, a as createWebHistory, ct as resolveComponent, f as storeToRefs, g as createApp, i as createWebHashHistory, it as openBlock, j as computed, l as createPinia, ot as renderList, r as createRouter, st as renderSlot, tt as onMounted, ut as resolveDynamicComponent, xt as withCtx, z as createTextVNode } from "./vendor-vue-core-D3WB7mNE.js";
import { $ as isEqual, Dt as VueFireAuth, Et as VueFire } from "./vendor-other-CcVI76zn.js";
import { $i as capturePreservedQuery, Ai as useSubscriptionDialog, Bi as useTeamWorkspaceStore, C as app$1, Cs as isWidgetValue, Qi as PRESERVED_QUERY_NAMESPACES, Ss as toNodeId, Xo as usePreviewExposureStore, Yi as useAuthStore, Zo as nextUniqueName, a as getPromotableWidgets, bs as UNASSIGNED_NODE_ID, do as parseProxyWidgets, ds as promotedInputWidget, fo as resolveConcretePromotedWidget, gs as useWidgetValueStore, hi as useDialogService, i as findHostInputForPromotion, l as isPreviewPseudoWidget, lt as DialogFooter_default, ms as resolveSubgraphInputTarget, rt as useWorkspaceStore, so as LGraph, t as autoExposeKnownPreviewNodes, ta as hydratePreservedQuery, uo as parseProxyWidgetErrorQuarantine, ws as setAssertReporter } from "./promotionUtils-vKoNYnM9.js";
import { S as useFavicon, Y as promiseTimeout, nt as until } from "./vendor-vueuse-BA2QXdyV.js";
import { a as remoteConfig } from "./remoteConfig-DjUkM6Dg.js";
import { r as useI18n } from "./vendor-i18n-BVGbvPvq.js";
import { n as i18n } from "./i18n-DAE2CSwM.js";
import "./toastStore-BIphcVgz.js";
...
import { d as DialogOverlay_default, f as DialogContent_default, l as DialogTitle_default, n as DialogClose_default, p as Dialog_default, t as DialogHeader_default, u as DialogPortal_default } from "./DialogHeader-DkWnDCOh.js";
import { t as refreshRemoteConfig$1 } from "./refreshRemoteConfig-B062BsUD.js";
import { t as captureOAuthRequestId } from "./oauthState-0r1ukMzs.js";
import { g as preserveLoggedOutShareAuthAttribution, m as useBootstrapStore, p as config_default, t as useConflictDetection } from "./useConflictDetection-Cu2ufjrq.js";
import { t as vRekaZIndex } from "./vRekaZIndex-C6RPDF_x.js";
		...
		*/
		...
		async function initialize() {
			...
			try {
				...
				try {
					await Promise.race([refreshRemoteConfig$1({ useAuth: true }), promiseTimeout(CONFIG_REFRESH_TIMEOUT_MS).then(() => {
...
var cloudOnboardingRoutes = isCloud ? (await __vitePreload(async () => {
	const { cloudOnboardingRoutes } = await import("./onboardingCloudRoutes-DCcIXn4P.js");
...
var router = createRouter({
	...
	routes: [...isCloud ? cloudOnboardingRoutes : [], {
		...
		children: [{
			...
			path: "login",
			name: "LoginView",
			component: () => __vitePreload(() => import("./LoginView-kUQEskZH.js"), __vite__mapDeps([83,1,2,3,33,8,9,10,11,12,13,25,21,54,20,16,17,22,23,46,79]), import.meta.url)
		}]
	}],
	...
	router.beforeEach(async (to, _from, next) => {
		...
		if (!isDesktop && isLoggedIn && to.path === "/") {
			...
			const { getSurveyCompletedStatus } = await __vitePreload(async () => {
				const { getSurveyCompletedStatus } = await import("./auth-sAZvtlsO.js");
				return { getSurveyCompletedStatus };
			}, __vite__mapDeps([84,85,1,8,9,10,11,3,12,15,20,2,16,17,21,22,23,58,79]), import.meta.url);
			try {
...
var { refreshRemoteConfig } = await __vitePreload(async () => {
	const { refreshRemoteConfig } = await import("./refreshRemoteConfig-kXEJbu09.js");
	return { refreshRemoteConfig };
}, __vite__mapDeps([86,87,1,2,3,48,16]), import.meta.url);
await refreshRemoteConfig({ useAuth: false });
if (hasHostTelemetryBridge) {
	const { initHostTelemetry } = await __vitePreload(async () => {
		const { initHostTelemetry } = await import("./initHostTelemetry-B5KQBQja.js");
		return { initHostTelemetry };
	}, __vite__mapDeps([88,1,16,3,48,52,53,23]), import.meta.url);
	initHostTelemetry();
}
...
//# sourceMappingURL=index-BqjkQQDR.js.map