const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./i18n-BCSdytum.js","./i18n-DzSsN4Ea.js","./rolldown-runtime-w0pxe0c8.js","./vendor-primevue-Di5q1E0M.js","./vendor-vue-core-ywZ1En3W.js","./vendor-i18n-BitfRK9w.js","./commands-CXXLFVIe.js","./main-BSJkLqvQ.js","./nodeDefs-DNc3psLh.js","./settings-CXXL4Tkc.js"])))=>i.map(i=>d[i]);
import { a as __toESM, r as __name } from "./rolldown-runtime-w0pxe0c8.js";
import { H as script$4, P as script$3, Q as __vitePreload, R as script$1, X as script, Z as script$5, _ as script$2 } from "./vendor-primevue-Di5q1E0M.js";
import { A as computed, At as readonly, Bt as unref, C as withModifiers, Et as isRef, Gt as toDisplayString, H as getCurrentInstance, Ht as normalizeClass, It as toRef, J as mergeModels, K as inject, M as createBlock, N as createCommentVNode, P as createElementBlock, Pt as shallowRef, Q as onBeforeUnmount, R as createTextVNode, Rt as toValue, S as withKeys, T as Fragment, V as defineComponent, Wt as normalizeStyle, X as nextTick, _ as useCssVars, _t as watchEffect, at as renderList, bt as withCtx, ct as resolveDirective, d as storeToRefs, et as onMounted, ft as useId, gt as watch, it as provide, j as createBaseVNode, jt as ref, l as defineStore, ot as renderSlot, pt as useModel, rt as openBlock, tt as onUnmounted, x as vShow, xt as withDirectives, z as createVNode } from "./vendor-vue-core-ywZ1En3W.js";
import { $ as memoize, D as require_quick_lru, G as pickBy, K as omit, W as isEmpty, _t as map, at as some, dt as partition, et as debounce, ft as orderBy, gt as flatMap, j as require_semver, l as liteClient, mt as groupBy, ot as isNil, q as merge, rt as uniqBy, u as v4, vt as find, yt as filter } from "./vendor-other-DslE47pR.js";
import { C as app, J as useNodeDefStore, Ji as useColorPaletteStore, Qr as VirtualGrid_default, Ti as NoResultsPlaceholder_default, Ui as searchInputSizeConfig, Vi as BaseModalLayout_default, Wi as searchInputVariants, _t as normalizePackKeys, ai as SingleSelect_default, b as useWorkflowStore, ea as useSettingStore, go as isAbortError, gt as normalizePackId, hi as useCommandStore, ho as mapAllNodes, ii as LeftSidePanel_default, lr as ModelInfoField_default, pi as useDialogService, si as usePrimeVueOverlayChildStyle, ta as transformInputSpecV1ToV2, to as collectAllNodes, ur as PropertiesAccordionItem_default, yi as useSettingsDialog, yt as NodePreview_default } from "./promotionUtils-BlyjkT7V.js";
import { r as useI18n } from "./vendor-i18n-BitfRK9w.js";
import { s as t } from "./i18n-DzSsN4Ea.js";
import { r as api } from "./api-DtOML0NT.js";
import { H as useStorage, J as get, ct as whenever, d as useAsyncState, q as createSharedComposable, st as watchDebounced, tt as until, x as useEventListener } from "./vendor-vueuse-D8rwdKM0.js";
import { t as useToastStore } from "./toastStore-Dafwoqcw.js";
import { t as axios } from "./vendor-axios-BWFjRHOY.js";
import { D as paramsToCacheKey, S as isValidUrl } from "./formatUtil-NyC-AHAf.js";
import { ct as ComboboxItem_default, dt as ComboboxContent_default, ft as ComboboxRoot_default, lt as ComboboxInput_default, ot as ComboboxPortal_default, vt as ComboboxAnchor_default } from "./vendor-reka-ui-BL45aHvm.js";
...
import { n as OnCloseKey } from "./widgetTypes-DKb0MXCf.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BKp_-DiS.js";
import { n as useSystemStatsStore, r as useCopyToClipboard } from "./extensionStore-CveIbRwz.js";
import { t as useExternalLink } from "./useExternalLink-BniNQVDC.js";
import { n as toError } from "./errorUtil-DDkl_YIv.js";
...
var useBootstrapStore = defineStore("bootstrap", () => {
	...
	const { isReady: isI18nReady, error: i18nError, execute: loadI18n } = useAsyncState(async () => {
		const { mergeCustomNodesI18n } = await __vitePreload(async () => {
			const { mergeCustomNodesI18n } = await import("./i18n-BCSdytum.js");
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$2, [
				...
				createBaseVNode("div", _hoisted_5$1, [createBaseVNode("div", _hoisted_6$1, [createVNode(unref(script$5), {
					...
					createBaseVNode("div", _hoisted_9, [createVNode(unref(script$5), {
						width: "4rem",
						height: "1.5rem",
						"border-radius": "0.75rem"
					}), createVNode(unref(script$5), {
...
//# sourceMappingURL=useConflictDetection-CHgKB5fR.js.map