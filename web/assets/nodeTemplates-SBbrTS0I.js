...
import { C as app, G as ComfyDialog, O as deserialiseAndCreate, W as $el, pi as useDialogService } from "./promotionUtils-BjUDpLi8.js";
...
var ManageTemplates = class extends ComfyDialog {
	...
	async load() {
		...
		else if (res.status !== 404 && res.status !== 401) console.error(res.status + " " + res.statusText);
		return templates ?? [];
	}
	async store() {
...
//# sourceMappingURL=nodeTemplates-SBbrTS0I.js.map