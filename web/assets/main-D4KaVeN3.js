...
var auth = {
	...
	"errors": {
		...
		"signupBlocked": "Сейчас не удалось создать ваш аккаунт. Пожалуйста, попробуйте позже. Если проблема повторяется, напишите на 363273196@qq.com."
	},
	"login": {
		"andText": "и",
		"backToGithubLogin": "Зарегистрироваться через Github",
	...
	"signOut": {
		"saveFailed": "Выход отменён, так как не удалось сохранить «{workflow}».",
		"signOut": "Выйти",
		"signOutAnyway": "Выйти всё равно",
...
var cloudSurvey_steps_usage = "Как вы планируете использовать ComfyUI?";
...
var comfyHubPublish = {
	...
	"publishSuccessDescription": "Ваш рабочий процесс теперь доступен на ComfyHub.",
...
var oauth = {
	"consent": {
		...
		"workspaceHelp": "Разрешения применяются только к этому рабочему пространству.",
...
var workspacePanel = {
	"changeRoleDialog": {
		"demoteConfirm": "Понизить до участника",
		"demoteMessage": "Он(а) потеряет права администратора.",
		"demoteTitle": "Понизить {name} до участника?",
		"error": "Не удалось обновить роль",
		"promoteConfirm": "Сделать владельцем",
		"promoteIntro": "Он(а) сможет:",
		"promotePermissionCredits": "Добавлять дополнительные кредиты",
		"promotePermissionManage": "Управлять участниками, способами оплаты и настройками рабочей области",
		"promotePermissionRoles": "Повышать и понижать других владельцев (кроме создателя рабочей области).",
		"promoteTitle": "Сделать {name} владельцем?",
	...
	"inviteMemberDialog": {
		"failedCount": "Не удалось отправить {count} приглашение. Попробуйте еще раз. | Не удалось отправить {count} приглашения. Попробуйте еще раз. | Не удалось отправить {count} приглашений. Попробуйте еще раз.",
		"invalidEmailCount": "{count} некорректный адрес электронной почты | {count} некорректных адреса электронной почты | {count} некорректных адресов электронной почты",
		"invitedMessage": "Приглашение отправлено на {emails} | Приглашения отправлены на {emails}",
		"placeholder": "Введите email человека",
		"seatLimitReached": "Вы можете пригласить до {count} участника. | Вы можете пригласить до {count} участников.",
	...
	"inviteUpsellDialog": {
		...
		"upgradeToTeam": "Обновить до Team"
	},
	"leaveDialog": {
		"leave": "Покинуть",
	...
	"members": {
		...
		"reactivateTeam": "Активировать Team",
		"searchPlaceholder": "Поиск...",
		"tabs": {
			"active": "Активные",
		...
		"upgradeToTeam": "Обновить до Team",
		"upsellBanner": "Чтобы добавить участников, обновите ваш тарифный план.",
		"upsellBannerReactivate": "Чтобы добавить больше участников, активируйте ваш тарифный план."
	},
	"menu": {
		"creatorCannotLeave": "Создатель рабочей области не может покинуть созданную им рабочую область",
	...
	"toast": {
		...
		"inviteResendFailed": "Не удалось повторно отправить приглашение",
		"inviteResent": "Приглашение повторно отправлено",
		"workspaceCreated": {
