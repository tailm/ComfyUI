...
import { X as script$2, m as script$1, q as script } from "./vendor-primevue-CQFMRQbS.js";
...
import { ea as useSettingStore } from "./promotionUtils-DLM4TsXW.js";
...
import { n as isNativeWindow, t as electronAPI } from "./envUtil-DEoYkEM7.js";
		...
		const handleLogin = async () => {
			...
			try {
				...
				if (data.success) {
					...
					settingStore.resetLoadState();
					bootstrapStore.resetStoresLoaded();
					await userStore.initialize();
					bootstrapStore.loadAuthenticatedStores();
					await router.push("/");
				} else {
...
//# sourceMappingURL=LoginView-13oNyWfu.js.map