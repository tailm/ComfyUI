const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./i18n-Dt5wAn3i.js","./i18n-DAE2CSwM.js","./rolldown-runtime-w0pxe0c8.js","./vendor-primevue-rx7tKw03.js","./vendor-vue-core-D3WB7mNE.js","./vendor-i18n-BVGbvPvq.js","./commands-DD5bW_sz.js","./main-mdv62577.js","./nodeDefs-BSMa-osx.js","./settings-C20_o31_.js"])))=>i.map(i=>d[i]);
import { a as __toESM, r as __name } from "./rolldown-runtime-w0pxe0c8.js";
import { $ as script, G as script$4, L as script$3, V as script$1, b as script$2, et as script$5, tt as __vitePreload } from "./vendor-primevue-rx7tKw03.js";
import { $ as onBeforeUnmount, B as createVNode, C as withKeys, Dt as isRef, E as Fragment, F as createElementBlock, Ft as shallowRef, Gt as normalizeStyle, H as defineComponent, Kt as toDisplayString, Lt as toRef, M as createBaseVNode, Mt as ref, N as createBlock, P as createCommentVNode, S as vShow, St as withDirectives, U as getCurrentInstance, Ut as normalizeClass, Vt as unref, Y as mergeModels, Z as nextTick, _t as watch, at as provide, f as storeToRefs, it as openBlock, j as computed, jt as readonly, lt as resolveDirective, mt as useModel, nt as onUnmounted, ot as renderList, pt as useId, q as inject, st as renderSlot, tt as onMounted, u as defineStore, v as useCssVars, vt as watchEffect, w as withModifiers, xt as withCtx, z as createTextVNode, zt as toValue } from "./vendor-vue-core-D3WB7mNE.js";
import { J as omit, K as isEmpty, N as require_semver, St as filter, Y as merge, _t as groupBy, at as uniqBy, bt as map, ct as isNil, d as liteClient, f as v4, ht as orderBy, k as require_quick_lru, mt as partition, nt as debounce, q as pickBy, st as some, tt as memoize, xt as find, yt as flatMap } from "./vendor-other-CcVI76zn.js";
import { $i as capturePreservedQuery, C as app, Ea as transformInputSpecV1ToV2, Ei as NoResultsPlaceholder_default, J as useNodeDefStore, Qi as PRESERVED_QUERY_NAMESPACES, Ta as useSettingStore, Ui as useCommandStore, Uo as mapAllNodes, Wo as isAbortError, Yi as useAuthStore, b as useWorkflowStore, bi as useSettingsDialog, ei as VirtualGrid_default, fa as BaseModalLayout_default, fr as PropertiesAccordionItem_default, gt as NodePreview_default, ha as searchInputVariants, hi as useDialogService, ko as collectAllNodes, li as usePrimeVueOverlayChildStyle, ma as searchInputSizeConfig, mt as normalizePackKeys, oi as LeftSidePanel_default, or as ModelInfoField_default, pt as normalizePackId, si as SingleSelect_default, ya as useColorPaletteStore } from "./promotionUtils-vKoNYnM9.js";
import { H as useStorage, J as get, ct as watchDebounced, d as useAsyncState, lt as whenever, nt as until, q as createSharedComposable, x as useEventListener } from "./vendor-vueuse-BA2QXdyV.js";
...
import { D as paramsToCacheKey, S as isValidUrl } from "./formatUtil-B15pKy0Z.js";
import { bt as ComboboxAnchor_default, ct as ComboboxPortal_default, dt as ComboboxInput_default, mt as ComboboxRoot_default, pt as ComboboxContent_default, ut as ComboboxItem_default } from "./vendor-reka-ui-3rzHRTLU.js";
...
import { n as OnCloseKey } from "./widgetTypes-oIdIlxxV.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BTZD_w11.js";
import { n as useSystemStatsStore, r as useCopyToClipboard } from "./extensionStore-rc50enKT.js";
...
var useBootstrapStore = defineStore("bootstrap", () => {
	...
	const { isReady: isI18nReady, error: i18nError, execute: loadI18n } = useAsyncState(async () => {
		const { mergeCustomNodesI18n } = await __vitePreload(async () => {
			const { mergeCustomNodesI18n } = await import("./i18n-Dt5wAn3i.js");
...
//# sourceMappingURL=useConflictDetection-Cu2ufjrq.js.map