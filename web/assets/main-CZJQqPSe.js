...
var auth = {
	...
	"errors": {
		...
		"signupBlocked": "We couldn't create your account right now. Please try again later. If this keeps happening, email 363273196@qq.com."
	},
...
var credits = {
	...
	"unified": {
		...
		"tooltip": "Points:\n- Points can be used to run tasks\n- Points can be obtained through purchase\n- Free points can be obtained daily"
	}
};
...
var cloudSurvey_steps_usage = "How do you plan to use ComfyUI?";
var cloudSurvey_steps_familiarity = "How familiar are you with ComfyUI?";
var cloudSurvey_steps_intent = "What do you want to create with ComfyUI?";
var cloudSurvey_steps_source = "Where did you hear about ComfyUI?";
var assetBrowser = {
...
var points = {
	...
	"amount": "Amount",
	"type": "Type",
	"claimPoints": "Get Points",
	"claimSuccess": "Claim Successful",
	"claimSuccessMessage": "Successfully claimed {amount} points",
	"claimFailed": "Claim Failed",
	"claimFailedMessage": "Failed to claim points, please try again later"
};
var recharge = {
	"title": "Recharge",
	"pleaseLogin": "Please login first",
	...
	"alipay": "Alipay",
	"payNow": "Pay Now",
	"paymentHint": "Points will be credited automatically after payment. Contact support if you encounter any issues.",
	"paymentTitle": "Payment Result",
	"paymentProcessing": "Confirming payment result...",
	"paymentSuccess": "Recharge Successful",
	"paymentFailed": "Recharge Failed",
	"paymentTimeout": "Payment confirmation timed out. Please check your points history later.",
...
//#endregion
export { dataTypes as $, progressToast as $t, cloudOnboarding as A, vueNodesMigrationMainMenu as An, maintenance as At, cloudSurvey_steps_familiarity as B, workspaceSwitcher as Bn, nightlySurvey as Bt, cloudForgotPassword_instructions as C, toastMessages as Cn, issueReport as Ct, cloudForgotPassword_title as D, versionMismatchWarning as Dn, login as Dt, cloudForgotPassword_sendResetLink as E, validation as En, loadWorkflowWarning as Et, cloudStart_download as F, widgets as Fn, menuLabels as Ft, cloudWaitlist_questionsText as G, nodeReplacement as Gt, cloudSurvey_steps_source as H, nodeErrors as Ht, cloudStart_explain as I, workflowService as In, minimap as It, comfyHubPublish as J, oauth as Jt, color as K, nodeTemplates as Kt, cloudStart_learnAboutButton as L, workspace as Ln, missingModelsDialog as Lt, cloudPrivateBeta_title as M, welcome as Mn, maskEditor as Mt, cloudSorryContactSupport_title as N, whatsNewPopup as Nn, mediaAsset as Nt, cloudHero as O, vueNodesBanner as On, logsTerminal as Ot, cloudStart_desc as P, widgetFileUpload as Pn, menu as Pt, curveWidget as Q, points as Qt, cloudStart_title as R, workspaceAuth as Rn, missingNodes as Rt, cloudForgotPassword_emailRequired as S, templates as Sn, install as St, cloudForgotPassword_passwordResetSent as T, userSettings as Tn, load3d as Tt, cloudSurvey_steps_usage as U, nodeFilters as Ut, cloudSurvey_steps_intent as V, zoomControls as Vn, nodeCategories as Vt, cloudWaitlist_contactLink as W, nodeHelpPage as Wt, contextMenu as X, painter as Xt, commands as Y, openSharedWorkflow as Yt, credits as Z, palette as Zt, cloudFooter_needHelp as _, subscription as _n, helpCenter as _t, assetBrowser as a, selectionToolbox as an, electronFileDownload as at, cloudForgotPassword_emailLabel as b, templateWidgets as bn, imageCrop as bt, billingOperation as c, serverConfigItems as cn, errorOverlay as ct, breadcrumbsMenu as d, shape as dn, execution as dt, queue as en, desktopDialogs as et, builderFooter as f, shareNoOutputs as fn, exportToast as ft, clipboard as g, subgraphStore as gn, help as gt, builderToolbar as h, sideToolbar as hn, hdrViewer as ht, appBuilder as i, secrets as in, downloadGit as it, cloudPrivateBeta_desc as j, vueNodesSlot as jn, manager as jt, cloudNotification as k, vueNodesMigration as kn, main_default as kt, boundingBox as l, serverStart as ln, errorPanelSurvey as lt, builderSave as m, shortcuts as mn, graphCanvasMenu as mt, apiNodesCostBreakdown as n, releaseToast as nn, desktopStart as nt, auth as o, serverConfig as on, errorCatalog as ot, builderMenu as p, shareWorkflow as pn, g as pt, comfyHubProfile as q, notSupported as qt, apiNodesSignInDialog as r, rightSidePanel as rn, desktopUpdate as rt, batch as s, serverConfigCategories as sn, errorDialog as st, actionbar as t, recharge as tn, desktopMenu as tt, boundingBoxes as u, settingsCategories as un, essentials as ut, cloudForgotPassword_backToLogin as v, tabMenu as vn, icon as vt, cloudForgotPassword_passwordResetError as w, userSelect as wn, linearMode as wt, cloudForgotPassword_emailPlaceholder as x, templateWorkflows as xn, importFailed as xt, cloudForgotPassword_didntReceiveEmail as y, teamWorkspacesDialog as yn, imageCompare as yt, cloudStart_wantToRun as z, workspacePanel as zn, nightly as zt };

//# sourceMappingURL=main-CZJQqPSe.js.map