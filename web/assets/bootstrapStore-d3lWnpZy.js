const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./i18n-SbrVFZp7.js","./i18n-JcytnyXX.js","./rolldown-runtime-w0pxe0c8.js","./vendor-primevue-Di5q1E0M.js","./vendor-vue-core-ywZ1En3W.js","./vendor-i18n-BitfRK9w.js","./commands-CXXLFVIe.js","./main-CZJQqPSe.js","./nodeDefs-DNc3psLh.js","./settings-CXXL4Tkc.js"])))=>i.map(i=>d[i]);
...
import { b as useWorkflowStore, ea as useSettingStore } from "./promotionUtils-BjUDpLi8.js";
...
var useBootstrapStore = defineStore("bootstrap", () => {
	...
	const { isReady: isI18nReady, error: i18nError, execute: loadI18n } = useAsyncState(async () => {
		const { mergeCustomNodesI18n } = await __vitePreload(async () => {
			const { mergeCustomNodesI18n } = await import("./i18n-SbrVFZp7.js");
...
//# sourceMappingURL=bootstrapStore-d3lWnpZy.js.map