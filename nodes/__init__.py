...
sys.path.insert(0, os.path.join(repo_root, "comfy"))
...
class CLIPTextEncode(ComfyNodeABC):
    ...
    def IS_CHANGED(cls, text, clip):
        # Return a hash of the text content to invalidate cache when text changes
        # Use hash to ensure consistent cache key generation
        import hashlib
...
async def init_builtin_extra_nodes():
    ...
    Returns:
        None
    """
    extras_dir = os.path.join(repo_root, "comfy_extras")
    extras_files = [
        "nodes_latent.py",
