...
if args.base_directory:
    ...
    # Preserve the historical behavior of resolving paths relative to the repository root
    # even though this module now lives in a package directory.
...
def get_user_directory_by_type(directory_type: str, user_id: Optional[str] = None) -> str:
    ...
    This is the central routing function for all user data isolation.
    It automatically routes file operations to user-specific directories
